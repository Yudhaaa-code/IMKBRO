...
<div class="mt-2 mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 mb-20">
    ...
    <div class="grid grid-cols-2 gap-4 p-2 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <a href="#" class="group relative block overflow-hidden">
            <img
              src="{{ asset('storage/img_pb/' . $point->image) }}"
              alt="Robot Toy"
            ...
            <div class="relative bg-zinc-800 p-2 rounded-b-lg">
              ...
              <h3 class="mt-2 text-sm font-medium text-zinc-100">{{ Str::limit($point->title, 35) }}</h3>
              <p class="mt-1 text-xs text-zinc-300">Rp.{{ $point->price }}</p>
