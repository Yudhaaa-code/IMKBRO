    ...
    <div class="p-4 lg:max-w-7xl max-w-4xl mx-auto">
      <div class="grid items-start grid-cols-1 lg:grid-cols-5 gap-12 shadow-[0_2px_10px_-3px_rgba(169,170,172,0.8)] p-6 rounded">
        ...
        <div class="lg:col-span-2">
          <h3 class="text-xl font-bold text-zinc-100">Acer Aspire Pro 12 | Laptop</h3>
          

          <p class="text-sm text-zinc-300 mt-2">The Acer Aspire Pro 12 is a sleek and powerful laptop, designed for productivity and performance. Perfect for professionals and multitaskers.</p>

          <div class="flex flex-wrap gap-4 mt-6">
            <p class="text-zinc-100 text-2xl font-bold mt-32">$1200</p>
          </div>
